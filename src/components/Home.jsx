...
const Home = () => {
    return (
      <div
        name="home"
        className="h-screen w-full bg-gradient-to-b from-white to-purple-300"
      >
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
          <div className="flex flex-col justify-center h-full">
            ...
            My current focus is on building full stack web applications, with a focus on three dimensional graphics.
            </p>
